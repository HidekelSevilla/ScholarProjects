...
public class pantalla2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar el tamaño MAXIMO de filas y columnas en el Arreglo");
        ...
        if (jTextField2.getText().length()>0 && jTextField3.getText().length()>0){
            ...
            try{
              ...
              num2 = Integer.parseInt(jTextField3.getText());  
                ...
                jTextPane1.setText("Ingrese el formato correcto en la casilla");
             return;
            }
            ProoyectoInterfaz.arreglo = new Programador (num1, num2);
            jTextPane1.setText("\nDato del arreglo agregado");
            ProoyectoInterfaz obj;
            obj = new ProoyectoInterfaz();
            obj.setVisible(true);
            dispose();
        }else 
           jTextPane1.setText("Faltan datos en las casillas");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                  new pantalla2().setVisible(false);
            }
        });
    }
